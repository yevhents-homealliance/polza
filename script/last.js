document.addEventListener('DOMContentLoaded', (e) => {
    ...
    */
    ...
    function validateForm() {
        ...
        for (let i = 0; i < inputs.length; i++) {
            if (inputs[i].value == '') {
                ...
                document.querySelector('.' + inputs[i].id + '-invalid').innerHTML = 'РћР±РѕРІ\'СЏР·РєРѕРІРµ РїРѕР»Рµ'
                valid = false
            } else {
        ...
        if (!reg.test(email.value)) {
            ...
            document.querySelector('.email-invalid').innerHTML = 'РќРµРїСЂР°РІРёР»СЊРЅР° РµР»РµРєС‚СЂРѕРЅРЅР° Р°РґСЂРµСЃР°'
        } else {
    ...
    function submitForm() {
        ...
        data.append("page", "РЇРє СЃС‚Р°С‚Рё С–РЅРІРµСЃС‚РѕСЂРѕРј");
